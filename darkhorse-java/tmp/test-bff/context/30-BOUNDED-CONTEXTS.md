...
> Inventory of bounded contexts in **test-bff**.

## Contexts

> No bounded contexts defined yet. Add your first context:
>
> 1. Create `backend/contexts/<context-name>/` with domain/application/infrastructure/presentation layers
...
- **Location:** `backend/bffs/contexts/order-management/`
