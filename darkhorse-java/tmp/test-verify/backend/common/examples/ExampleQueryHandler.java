 ...
 * and return aggregated/transformed responses to the frontend.
 *
...
public class ExampleQueryHandler {
     ...
     * 2. Call downstream API via REST client
    ...
    public Object handle(/* GetOrderByIdQuery query */) {
        ...
        // ExternalOrderResponse response = orderApiClient.getById(query.getOrderId());
