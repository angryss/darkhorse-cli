...
describe('TreeMap', () => {
  ...
  describe('Rendering', () => {
    it('should render treemap with data', () => {
      render(<TreeMap data={sampleData} />);
    ...
    it('should render with custom dimensions', () => {
      const { container } = render(
        <TreeMap data={sampleData} height={500} width="80%" />
      );
      
      const treeMap = container.firstChild as HTMLElement;
    ...
    it('should render with custom className', () => {
      const { container } = render(
        <TreeMap data={sampleData} className="custom-treemap" />
      );
  ...
  describe('Interactions', () => {
    it('should call onItemClick when rectangle is clicked', async () => {
      ...
      render(<TreeMap data={sampleData} onItemClick={onItemClick} />);
    ...
    it('should call onItemHover when rectangle is hovered', async () => {
      ...
      render(<TreeMap data={sampleData} onItemHover={onItemHover} />);
  ...
  describe('Drill-Down', () => {
    ...
    it('should show breadcrumb after drilling down', async () => {
      ...
      render(<TreeMap data={sampleData} drillDown={true} />);
  ...
  describe('Borders', () => {
    ...
    it('should hide borders when showBorder is false', () => {
      render(<TreeMap data={sampleData} showBorder={false} />);
    ...
    it('should apply custom border color', () => {
      render(<TreeMap data={sampleData} borderColor="#ff0000" />);
  ...
  describe('Error Handling', () => {
    it('should call onError when an error occurs', () => {
      ...
      render(<TreeMap data={[] as TreeMapDataItem[]} onError={onError} />);
