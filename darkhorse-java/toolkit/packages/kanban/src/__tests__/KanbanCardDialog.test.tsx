...
import type { KanbanCard, KanbanCardDialogField } from '../types';
...
describe('KanbanCardDialog', () => {
  ...
  const mockFields: KanbanCardDialogField[] = [
  ...
  describe('Rendering', () => {
    it('should render dialog when open', () => {
      render(<KanbanCardDialog {...defaultProps} />);
      expect(screen.getByRole('dialog')).toBeInTheDocument();
      expect(screen.getByText('Edit Card')).toBeInTheDocument();
    });

    it('should not render when closed', () => {
      render(<KanbanCardDialog {...defaultProps} open={false} />);
    ...
    it('should pre-populate fields with card data', () => {
      ...
      const summaryInput = screen.getByLabelText(/description/i) as HTMLTextAreaElement;
  ...
  describe('Validation', () => {
    it('should show error for empty required field', async () => {
      const onSave = vi.fn();
      render(<KanbanCardDialog {...defaultProps} onSave={onSave} />);
  ...
  describe('Actions', () => {
    ...
    it('should call onClose when cancel is clicked', () => {
      const onClose = vi.fn();
      render(<KanbanCardDialog {...defaultProps} onClose={onClose} />);
    ...
    it('should call onDelete after confirmation', () => {
      ...
      render(<KanbanCardDialog {...defaultProps} onDelete={onDelete} />);
