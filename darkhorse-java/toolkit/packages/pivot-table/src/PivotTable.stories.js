 ...
 */
export const MultipleAggregations = {
    args: {
        data: salesData,
        config: {
            rows: [{ field: 'region', caption: 'Region' }],
 ...
 */
export const MinMaxAggregation = {
    args: {
        data: salesData,
        config: {
            rows: [{ field: 'region' }],
 ...
 */
export const WithExcludeFilters = {
    args: {
        data: salesData,
        config: {
            rows: [{ field: 'region' }],
 ...
 */
export const DistinctCountAggregation = {
    args: {
        data: salesData,
        config: {
            rows: [{ field: 'region' }],
...
//# sourceMappingURL=PivotTable.stories.js.map