# Requirements Guide — Java project
...
- platform context: bounded contexts, Quarkus resources, domain/application/infrastructure boundaries, persistence, and messaging.
