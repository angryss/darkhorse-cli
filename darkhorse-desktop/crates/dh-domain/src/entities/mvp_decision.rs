...
/// Captures a key decision about MVP direction — why a specific scope,
/// approach, or technical direction was chosen over alternatives.
...
impl MvpDecision {
    ...
    pub fn impact(&self) -> &DecisionImpact { &self.impact }
