...
|-------|---------|------------|
| **Domain** | `DarkHorse.Web.Domain` | NOTHING (zero dependencies) |
| **Application** | `DarkHorse.Web.Application` | Domain, Common |
| **Infrastructure** | `DarkHorse.Web.Infrastructure` | Application, Domain, Common |
| **Presentation** | `DarkHorse.Web.Presentation` | Application, Infrastructure, Common |
| **Common** | `DarkHorse.Web.Common` | Domain |
