 ...
 * Tool types
 */
export type ImageEditorTool = 'Crop' | 'Resize' | 'RotateLeft' | 'RotateRight' | 'FlipHorizontal' | 'FlipVertical' | 'ZoomIn' | 'ZoomOut' | 'ResetZoom' | 'Pan' | 'Brightness' | 'Contrast' | 'Saturation' | 'Hue' | 'Sharpen' | 'Blur' | 'Draw' | 'Eraser' | 'Shape' | 'Text' | 'Undo' | 'Redo' | 'Reset' | 'FitToScreen' | 'OriginalSize';
/**
...
export interface ImageEditorHandle {
    ...
    export: (format: ImageExportFormat, options?: {
        quality?: number;
        name?: string;
