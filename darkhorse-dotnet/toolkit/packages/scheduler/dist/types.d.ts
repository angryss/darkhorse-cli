 ...
 */
export type SchedulerView = 'Day' | 'Week' | 'WorkWeek' | 'Month' | 'Year' | 'Agenda' | 'TimelineDay' | 'TimelineWeek' | 'TimelineWorkWeek' | 'TimelineMonth' | 'TimelineYear';
/**
...
export interface SchedulerProps {
    ...
    onBeforeEventEdit?: (event: SchedulerEvent) => {
        cancel?: boolean;
    } | void;
    /** Error handler */
...
export interface SchedulerHandle {
    ...
    /** Open event editor */
    openEditor: (event: Partial<SchedulerEvent>, mode: 'Add' | 'Edit' | 'EditOccurrence' | 'EditSeries') => void;
    /** Close event editor */
    closeEditor: () => void;
