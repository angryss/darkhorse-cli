 ...
 */
export async function generateContext(config) {
    const filesCreated = [];
    const errors = [];
    try {
        ...
        // 00-START-HERE.md — the entry point for all agents and developers
        ...
        // 10-REPO-MAP.md — folder layout description
        ...
        // 30-BOUNDED-CONTEXTS.md — project bounded contexts
        ...
        // 50-SEARCH-QUERIES.md — search patterns for AI discovery
